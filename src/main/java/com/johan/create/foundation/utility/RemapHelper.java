...
import static com.johan.create.AllBlocks.ADJUSTABLE_CHAIN_GEARSHIFT;
import static com.johan.create.AllBlocks.ANDESITE_ENCASED_SHAFT;
import static com.johan.create.AllBlocks.BRASS_BELT_FUNNEL;
import static com.johan.create.AllBlocks.BRASS_TUNNEL;
import static com.johan.create.AllBlocks.ENCASED_CHAIN_DRIVE;
import static com.johan.create.AllBlocks.LINEAR_CHASSIS;
import static com.johan.create.AllBlocks.MECHANICAL_DRILL;
import static com.johan.create.AllBlocks.MECHANICAL_HARVESTER;
import static com.johan.create.AllBlocks.MECHANICAL_PLOUGH;
import static com.johan.create.AllBlocks.MECHANICAL_SAW;
import static com.johan.create.AllBlocks.PISTON_EXTENSION_POLE;
import static com.johan.create.AllBlocks.POWERED_LATCH;
import static com.johan.create.AllBlocks.POWERED_TOGGLE_LATCH;
import static com.johan.create.AllBlocks.PULSE_EXTENDER;
import static com.johan.create.AllBlocks.PULSE_REPEATER;
import static com.johan.create.AllBlocks.RADIAL_CHASSIS;
import static com.johan.create.AllBlocks.REDSTONE_CONTACT;
import static com.johan.create.AllBlocks.REDSTONE_LINK;
import static com.johan.create.AllBlocks.SECONDARY_LINEAR_CHASSIS;
import static com.johan.create.AllBlocks.SMART_OBSERVER;
import static com.johan.create.AllBlocks.SPEEDOMETER;
import static com.johan.create.AllBlocks.STRESSOMETER;
import static com.johan.create.AllBlocks.THRESHOLD_SWITCH;
import static com.johan.create.AllItems.ATTRIBUTE_FILTER;
import static com.johan.create.AllItems.COPPER_DIVING_BOOTS;
import static com.johan.create.AllItems.COPPER_DIVING_HELMET;
import static com.johan.create.AllItems.CRAFTER_SLOT_COVER;
import static com.johan.create.AllItems.GOLDEN_SHEET;
import static com.johan.create.AllItems.POWDERED_OBSIDIAN;
import static com.johan.create.AllItems.SCHEMATIC;
import static com.johan.create.AllItems.SCHEMATIC_AND_QUILL;
import static com.johan.create.AllItems.WAND_OF_SYMMETRY;
import static com.johan.create.AllItems.WHEAT_FLOUR;
import static com.johan.create.AllItems.WORLDSHAPER;
import static com.johan.create.Create.asResource;
import static com.johan.create.content.decoration.palettes.AllPaletteBlocks.ACACIA_WINDOW;
import static com.johan.create.content.decoration.palettes.AllPaletteBlocks.ACACIA_WINDOW_PANE;
import static com.johan.create.content.decoration.palettes.AllPaletteBlocks.BIRCH_WINDOW;
import static com.johan.create.content.decoration.palettes.AllPaletteBlocks.BIRCH_WINDOW_PANE;
import static com.johan.create.content.decoration.palettes.AllPaletteBlocks.DARK_OAK_WINDOW;
import static com.johan.create.content.decoration.palettes.AllPaletteBlocks.DARK_OAK_WINDOW_PANE;
import static com.johan.create.content.decoration.palettes.AllPaletteBlocks.JUNGLE_WINDOW;
import static com.johan.create.content.decoration.palettes.AllPaletteBlocks.JUNGLE_WINDOW_PANE;
import static com.johan.create.content.decoration.palettes.AllPaletteBlocks.OAK_WINDOW;
import static com.johan.create.content.decoration.palettes.AllPaletteBlocks.OAK_WINDOW_PANE;
import static com.johan.create.content.decoration.palettes.AllPaletteBlocks.ORNATE_IRON_WINDOW;
import static com.johan.create.content.decoration.palettes.AllPaletteBlocks.ORNATE_IRON_WINDOW_PANE;
import static com.johan.create.content.decoration.palettes.AllPaletteBlocks.SPRUCE_WINDOW;
import static com.johan.create.content.decoration.palettes.AllPaletteBlocks.SPRUCE_WINDOW_PANE;
...
import com.johan.create.foundation.data.recipe.CompatMetals;
