...
import static com.johan.create.AllTags.forgeItemTag;
import static com.johan.create.AllTags.AllItemTags.CREATE_INGOTS;
import static com.johan.create.AllTags.AllItemTags.CRUSHED_RAW_MATERIALS;
import static com.johan.create.AllTags.AllItemTags.PLATES;
import static com.johan.create.Create.REGISTRATE;
import static com.johan.create.foundation.data.recipe.CompatMetals.ALUMINUM;
import static com.johan.create.foundation.data.recipe.CompatMetals.LEAD;
import static com.johan.create.foundation.data.recipe.CompatMetals.NICKEL;
import static com.johan.create.foundation.data.recipe.CompatMetals.OSMIUM;
import static com.johan.create.foundation.data.recipe.CompatMetals.PLATINUM;
import static com.johan.create.foundation.data.recipe.CompatMetals.QUICKSILVER;
import static com.johan.create.foundation.data.recipe.CompatMetals.SILVER;
import static com.johan.create.foundation.data.recipe.CompatMetals.TIN;
import static com.johan.create.foundation.data.recipe.CompatMetals.URANIUM;

import com.johan.create.AllTags.AllItemTags;
import com.johan.create.content.contraptions.glue.SuperGlueItem;
import com.johan.create.content.contraptions.minecart.MinecartCouplingItem;
import com.johan.create.content.contraptions.mounted.MinecartContraptionItem;
import com.johan.create.content.equipment.BuildersTeaItem;
import com.johan.create.content.equipment.TreeFertilizerItem;
import com.johan.create.content.equipment.armor.AllArmorMaterials;
import com.johan.create.content.equipment.armor.BacktankItem;
import com.johan.create.content.equipment.armor.BacktankItem.BacktankBlockItem;
import com.johan.create.content.equipment.armor.DivingBootsItem;
import com.johan.create.content.equipment.armor.DivingHelmetItem;
import com.johan.create.content.equipment.blueprint.BlueprintItem;
import com.johan.create.content.equipment.extendoGrip.ExtendoGripItem;
import com.johan.create.content.equipment.goggles.GogglesItem;
import com.johan.create.content.equipment.goggles.GogglesModel;
import com.johan.create.content.equipment.potatoCannon.PotatoCannonItem;
import com.johan.create.content.equipment.sandPaper.SandPaperItem;
import com.johan.create.content.equipment.symmetryWand.SymmetryWandItem;
import com.johan.create.content.equipment.wrench.WrenchItem;
import com.johan.create.content.equipment.zapper.terrainzapper.WorldshaperItem;
import com.johan.create.content.kinetics.belt.item.BeltConnectorItem;
import com.johan.create.content.kinetics.gearbox.VerticalGearboxItem;
import com.johan.create.content.legacy.ChromaticCompoundColor;
import com.johan.create.content.legacy.ChromaticCompoundItem;
import com.johan.create.content.legacy.RefinedRadianceItem;
import com.johan.create.content.legacy.ShadowSteelItem;
import com.johan.create.content.logistics.filter.FilterItem;
import com.johan.create.content.materials.ExperienceNuggetItem;
import com.johan.create.content.processing.burner.BlazeBurnerBlockItem;
import com.johan.create.content.processing.sequenced.SequencedAssemblyItem;
import com.johan.create.content.redstone.link.controller.LinkedControllerItem;
import com.johan.create.content.schematics.SchematicAndQuillItem;
import com.johan.create.content.schematics.SchematicItem;
import com.johan.create.content.trains.schedule.ScheduleItem;
...
import com.johan.create.foundation.item.CombustibleItem;
import com.johan.create.foundation.item.HiddenIngredientItem;
import com.johan.create.foundation.item.ItemDescription;
import com.johan.create.foundation.item.TagDependentIngredientItem;
