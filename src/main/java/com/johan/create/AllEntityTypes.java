...
import com.johan.create.content.contraptions.ControlledContraptionEntity;
import com.johan.create.content.contraptions.OrientedContraptionEntity;
import com.johan.create.content.contraptions.actors.seat.SeatEntity;
import com.johan.create.content.contraptions.gantry.GantryContraptionEntity;
import com.johan.create.content.contraptions.glue.SuperGlueEntity;
import com.johan.create.content.contraptions.glue.SuperGlueRenderer;
import com.johan.create.content.contraptions.render.ContraptionEntityRenderer;
import com.johan.create.content.contraptions.render.OrientedContraptionEntityRenderer;
import com.johan.create.content.equipment.blueprint.BlueprintEntity;
import com.johan.create.content.equipment.blueprint.BlueprintRenderer;
import com.johan.create.content.equipment.potatoCannon.PotatoProjectileEntity;
import com.johan.create.content.equipment.potatoCannon.PotatoProjectileRenderer;
import com.johan.create.content.trains.entity.CarriageContraptionEntity;
import com.johan.create.content.trains.entity.CarriageContraptionEntityRenderer;
import com.johan.create.content.trains.entity.CarriageContraptionInstance;
import com.johan.create.foundation.data.CreateEntityBuilder;
